""" 
Файл містить маршрути для роботи з тегами у веб-додатку. Використовує FastAPI для створення
REST API та SQLAlchemy для взаємодії з базою даних. Функції огорнуті @router.post, @router.get та
...
- create_tag: Створення нового тегу. Доступно лише адміну. Повертає DTO TagRead з інформацією про
створений тег.
- list_tags: Отримання списку всіх тегів. Доступно будь-якому активному користувачу. Повертає
список DTO TagRead.
- delete_tag: Видалення тегу з глобальної таблиці. Доступно лише адміну. Повертає просте
