""" 
Файл для визначення репозиторію коментарів у базі даних. Містить клас CommentRepository, який надає
методи для створення, отримання, оновлення та видалення коментарів. Використовує SQLAlchemy для
взаємодії з базою даних та асинхронні сесії для ефективного виконання запитів. Методи огорнуті у
статичні методи, що дозволяє викликати їх без створення екземпляру класу.  
"""
